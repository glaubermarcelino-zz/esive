          ...
          <View style={styles.servicos}>
            <View
              ...
              <TouchableOpacity
                ...
                <Text style={styles.itemTitle}>Habilitação</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                <Text style={styles.itemTitle}>Infrações</Text>
              </TouchableOpacity>
            ...
            <View
              ...
              <TouchableOpacity
                ...
                <Text style={styles.itemTitle}>Veiculo</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.item]}
                onPress={() => handleNavigate()}
                ...
                <Text style={styles.itemTitle}>Educação</Text>
              </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              <TouchableOpacity
                ...
                <Text style={styles.itemTitle}>Social</Text>
              </TouchableOpacity>
            </View>
        </ScrollView>
      </SafeAreaView>
